...
function animations() {
  if (window.innerWidth >= 1170) {
    ...
    var tlStats = gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.timeline({
      scrollTrigger: {
        trigger: '.callback .stats',
        start: 'center bottom' // Начать анимацию при попадании элемента в центр экрана
      }
    });
    document.querySelectorAll('.about-list .item-number').forEach(function (item) {
      var numEl = item.querySelector('span');
      if (numEl) {
        var finalValue = numEl.textContent;
        numEl.textContent = 0;
        tl.to(numEl, {
    ...
    var items = gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.utils.toArray('.callback .stats .item-number span');
    var formatter = getFormatter(1);
    tlStats.from(items, {
      textContent: 0,
      duration: 3,
      ease: 'power1.in',
    ...
    function getFormatter(increment, pad) {
      var snap = gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.utils.snap(increment),
        exp = /\B(?=(\d{3})+(?!\d))/g,
        snapWithCommas = function snapWithCommas(value) {
          return (snap(+value) + '').replace(exp, ',');
        },
        whole = increment % 1 === 0,
        decimals = whole ? 0 : ((increment + '').split('.')[1] || '0').length;
      return !pad || whole ? snapWithCommas : function (value) {
        var s = snapWithCommas(value),
          i = s.indexOf('.');
        ~i || (i = s.length);
...
function forms() {
  ...
  var statusSelector = '.status-label';
  ...
  var setStatus = function setStatus(form, newStatus) {
    var statusEl = form.querySelector(statusSelector);
  ...
  var changeInputHandler = function changeInputHandler(e) {
  ...
  document.querySelectorAll('input[type="tel"]').forEach(function (input) {
    (0,imask__WEBPACK_IMPORTED_MODULE_1__["default"])(input, {
  ...
  document.querySelectorAll('form').forEach(function (form) {
    form.addEventListener('submit', function (e) {
      ...
      var validationErrors = validate_js__WEBPACK_IMPORTED_MODULE_0__(validate_js__WEBPACK_IMPORTED_MODULE_0__.collectFormValues(form), formConstraints);
      var isValid = !validationErrors;
      if (validationErrors && Object.keys(validationErrors)) {
        Object.keys(validationErrors).forEach(function (input) {
          form[input].classList.add('error');
          form[input].addEventListener('change', changeInputHandler, {
            once: true
          });
        });
      }
...
/* harmony export */ });
var MOBILE_MENU_BREAKPOINT = 992;
function mobileMenu() {
  var burger = document.getElementById('burger');
  var headerMenu = document.querySelector('.header .header-nav-wrap');
  ...
  document.querySelectorAll('.header-menu a + ul').forEach(function (item) {
...
/* harmony import */ var _modules_mobileMenu_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/mobileMenu.js */ "./src/js/modules/mobileMenu.js");
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  (0,_modules_mobileMenu_js__WEBPACK_IMPORTED_MODULE_4__["default"])();
  (0,_modules_animations_js__WEBPACK_IMPORTED_MODULE_5__["default"])();
  (function Hero() {
    var heroSliderSelector = '.hero-slider';
    if (!document.querySelector(heroSliderSelector)) {
      return;
    }
    var swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](heroSliderSelector, {
      modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_2__.Navigation, swiper_modules__WEBPACK_IMPORTED_MODULE_2__.Pagination, swiper_modules__WEBPACK_IMPORTED_MODULE_2__.EffectFade, swiper_modules__WEBPACK_IMPORTED_MODULE_2__.Parallax],
      pagination: {
        el: '.swiper-pagination',
        type: 'fraction'
      },
  ...
  (function ShowMore() {
    var btnSelector = '.btn-show-more';
    var cardsContainerSelector = '.cards';
    ...
    document.querySelector(btnSelector).addEventListener('click', function (e) {
      ...
      if (cardsContainer) {
        _toConsumableArray(cardsContainer.children).forEach(function (card) {
